...
export default function MobileBottomNav({ lang }: { lang: string }) {
  ...
  return (
    <nav
      className="lg:hidden fixed inset-x-0 bottom-0 z-[100] border-t border-gray-200 bg-white pb-[env(safe-area-inset-bottom,0px)] shadow-[0_-4px_24px_rgba(13,27,42,0.08)]"
