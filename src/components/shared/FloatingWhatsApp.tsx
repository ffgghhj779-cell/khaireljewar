...
export default function FloatingWhatsApp({ lang }: { lang: string }) {
  ...
  return (
    <div className="fixed z-50 flex flex-col items-end gap-3 bottom-[calc(10.5rem+env(safe-area-inset-bottom,0px))] end-4 lg:bottom-8 lg:end-8">
      <div
        className={`
      ...
      <motion.a
        ...
        whileTap={TAP_SCALE}
        className="
          relative w-14 h-14 lg:w-16 lg:h-16 min-w-[48px] min-h-[48px] bg-[#25D366] rounded-full shadow-2xl
          flex items-center justify-center touch-manipulation gpu-accelerated
      ...
      >
        ...
        <span className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-20 hidden lg:block" />
      </motion.a>
    </div>
  )
}
