...
export default function FloatingWhatsApp({ lang }: { lang: string }) {
  ...
  return (
    <div className="fixed z-[95] bottom-[calc(5.75rem+env(safe-area-inset-bottom,0px))] lg:bottom-8 end-3.5 lg:end-8">
      <a
        href={waUrl}
        target="_blank"
        rel="noopener noreferrer"
        className="
          flex h-12 w-12 min-w-[48px] min-h-[48px] items-center justify-center
          rounded-full bg-[#25D366] text-white shadow-lg
          touch-manipulation active:scale-[0.96] transition-transform duration-150
          lg:h-14 lg:w-14
        "
