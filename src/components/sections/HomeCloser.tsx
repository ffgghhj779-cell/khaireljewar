  ...
  return (
    <section className="relative z-0 overflow-hidden bg-primary py-12 md:py-40 border-t border-cream/10">
      ...
      <BotanicalMotif
        kind="cluster"
        tone="cream"
        className="absolute -bottom-6 -start-4 w-36 h-28 opacity-25 soft-float-slow hidden md:block"
      />
      <BotanicalMotif
        kind="leaf"
        tone="cream"
        className="absolute top-10 -end-2 w-20 h-24 opacity-20 soft-float hidden md:block"
      />
      ...
      <Container size="large" className="relative z-10">
        ...
        >
          ...
          <h2
            className={cn(
              'mb-5 text-[clamp(2rem,8vw,4rem)] font-medium text-cream leading-[1.12] tracking-tight text-balance md:mb-6',
          ...
          <p
            className={cn(
              'mx-auto mb-8 max-w-md text-[15px] md:mb-10 md:text-lg text-cream/75 leading-relaxed',
              isAr ? 'font-arabic' : 'font-display'
            )}
          >
            {isAr
          ...
          <div className="flex flex-col items-stretch justify-center gap-2.5 sm:flex-row sm:items-center sm:gap-4">
            <Link
              ...
              className={cn(
                ...
                'bg-cream text-primary font-semibold hover:bg-white',
            ...
            <Link
              href={`/${lang}/contact`}
              className={cn(
                'magnetic-cta inline-flex min-h-[48px] items-center justify-center rounded-xl border border-cream/35 px-8 touch-manipulation active:scale-[0.98]',
