  ...
  return (
    <section ref={containerRef} className="relative h-[75vh] overflow-hidden bg-dark flex items-center justify-center">
      ...
      >
        ...
        <div className="w-full h-full bg-[url('https://images.unsplash.com/photo-1601314167099-232775fe2bb1?q=80&w=1200&auto=format&fit=crop')] bg-cover bg-center" />
      </motion.div>
      ...
      >
        ...
        <p
          className={cn(
            'text-primary text-xl md:text-2xl mt-6 font-bold tracking-widest uppercase',
